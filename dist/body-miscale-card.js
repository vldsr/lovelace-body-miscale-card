...
@media (max-width: 400px) {
  ...
  .segment-label {
    ...
    `:K}renderState(e){var a,o,i,t,l;if(!this.config.show_states)return K;if(!this.hass||!(null===(a=this.config)||void 0===a?void 0:a.entity))return G`<div>${$l("state.default.unavailable")}</div>`;const n=null===(o=this.hass.states)||void 0===o?void 0:o[this.config.entity];if(!n)return G`<div>
      ...
      </div>`;const r=(null==e?void 0:e.key)&&n,s=r&&void 0!==(null===(i=n.attributes)||void 0===i?void 0:i[e.key]),d=r&&void 0!==n[e.key];let c=s?n.attributes[e.key]:d?n[e.key]:this.hass.localize("state.default.unavailable");if(("last_measurement_time"===e.key||"timestamp"===e.key)&&"string"==typeof c)try{const e=new Date(c.replace(" ","T").replace("+00:00","")),a={language:"ru",number_format:me.language,time_format:ue.twenty_four},o=ge(e,a);c=`${o} ${ye(e,a)}`}catch(e){}const _="number"==typeof c?ke(c,this.hass.locale):c,b=$l(`states.${c}`)||_,h="ok"===n.state&&"mdi:alert"===e.icon?K:G` <div class="state-div">
        ...
        ${this.hass.localize("state.default.unavailable")}
      </div>`;const r="function"==typeof e.compute?e.compute:e=>e,s=(null==e?void 0:e.key)&&n,d=s&&void 0!==(null===(i=n.attributes)||void 0===i?void 0:i[e.key]),c=s&&void 0!==n[e.key];let _=d?r(n.attributes[e.key]):c?r(n[e.key]):"----";if("last_measurement_time"===e.key&&"string"==typeof _)try{const e=new Date(_.replace(" ","T")),a=ge(e,this.hass.locale);_=`${a} ${ye(e,this.hass.locale)}`}catch(e){}else"gender"!=e.key||"male"!==_&&"female"!==_?"birthdate"==e.key&&(d||c)&&(_=function(e){const a=new Date,o=new Date(e);let i=a.getFullYear()-o.getFullYear();const t=a.getMonth()-o.getMonth(),l=a.getDate()-o.getDate();return(t<0||0===t&&l<0)&&i--,i}(_),e.unit=_>20&&_%10==1?" год":_>20&&(_%10==2||_%10==3||_%10==4)?" года":" лет"):_=this.renderIcon({icon:"male"===_?"mdi:human-male":"mdi:human-female",key:""},"default",!0);const b="number"==typeof _?ke(_,this.hass.locale):_,h=$l(`attributes_value.${_}`)||b,m=G`<div>
  ...
  `}getMinMaxFromSeverity(e){let a=1/0,o=-1/0;return e&&Array.isArray(e)&&e.forEach(e=>{const i=e.from,t=e.to;let l,n;if("number"==typeof i)l=i;else if("string"==typeof i&&"min"!==i){const e=parseFloat(i);isNaN(e)?"min"===i&&(l=-1/0):l=e}else"min"===i&&(l=-1/0);if("number"==typeof t)n=t;else if("string"==typeof t&&"max"!==t){const e=parseFloat(t);isNaN(e)?"max"===t&&(n=1/0):n=e}else"max"===t&&(n=1/0);void 0===l||isNaN(l)||(a=Math.min(a,l)),void 0===n||isNaN(n)||(o=Math.max(o,n))}),{min:a===1/0?0:a,max:o===-1/0?100:o}}_computePercent(e,a){if(!e||"number"!=typeof a)return 0;const o=e.max-e.min;return o<=0?0:(a-e.min)/o*100}renderColorBarSegments(e,a,o=!0){const{min:i,max:t}=this.getMinMaxFromSeverity(e.severity||[]),l=t-i;if(!e.severity||!Array.isArray(e.severity)||l<=0)return K;const n=e.severity.filter(e=>"disabled"!==e.color&&null!==e.from&&null!==e.to&&void 0!==e.color);if(0===n.length)return K;const r=n.map((a,o)=>{const r=parseFloat(a.from)||i,s=parseFloat(a.to)||t,d=(s-r)/l*100,c=jl(a.color)||"gray",_="false"!==e.showabovelabels,b="false"!==e.showbelowlabels,h=_&&o!==n.length-1?G`<div class="segment-label-above" style="color: ${c};">${ke(s,this.hass.locale)}${e.unit||""}</div>`:K,m=b&&a.label?G`<div class="segment-label-below" style="color: ${c};">${$l(`label_below.${a.label}`)||a.label||""}</div>`:K;return G`
    ...
    `;return o?G`<div class="bar-container">${_}</div>`:_}getIconUrl(e){var a,o;return`${null!==(o=null===(a=this.config)||void 0===a?void 0:a.icons_body)&&void 0!==o?o:"/local/images/bodyscoreIcon"}/${e}`}renderIcon(e,a="default",o=!1){var i,t,l;if(!this.hass||!(null===(i=this.config)||void 0===i?void 0:i.entity))return K;const n=this.hass.states[this.config.entity];if(!n)return K;const r="water"===e.key.toLowerCase()&&"water_icon"in n.attributes?n.attributes.water_icon:e.icon;if(!r)return K;const s=this.getIconUrl(e.icon);if("body"===a&&s)return G`
        <ha-icon
          class="image"
          style="
              ...
              ${(null===(t=this.config.styles)||void 0===t?void 0:t.iconbody)||""}"
        ></ha-icon>
      `;const d="none"!==n.attributes.problem&&"mdi:alert"===r;return G`
      <ha-icon
        class="${d?"problem":""}"
        icon="${r}"
        style="${o?"":"margin-right: 10px;"} ${(null===(l=this.config.styles)||void 0===l?void 0:l.icon)||""} ${d?"color: var(--error-color) !important;":""}"
      ></ha-icon>
    ...
    `:K}renderToolbar(){var e;if(!this.config.show_toolbar)return K;const a=this.config.show_always_details?"":G`<ha-icon-button
          @click=${this.toggle}
    ...
    `}renderDropdown(e,a){var o,i;if(!this.hass||!(null===(o=this.config)||void 0===o?void 0:o.entity))return K;const t=this.hass.states[this.config.entity];if(!(null==t?void 0:t.attributes))return K;const l=null!==(i=t.attributes[`${a}_list`])&&void 0!==i?i:[];return Array.isArray(l)&&0!==l.length?G` <div
...
`;xl(Rl);let Wl=class extends ne{constructor(){super(...arguments),this.page=1,this.selectedColor="white",this.config={},this.isInitialized=!1}setConfig(e){this.config=Object.assign({},e)}async connectedCallback(){super.connectedCallback(),await this.loadCardHelpers()}shouldUpdate(){return this.isInitialized||this.initialize(),!0}render(){if(!this.hass||!this.helpers)return K;const e=Object.assign(Object.assign({},El),this.config);return G`
    ...
    `}_handleConfigClick(){this.page=1}_handleCustomClick(){this.page=2}renderPage1(e){const a=Object.keys(this.hass.states).filter(e=>e.startsWith("bodymiscale.")||e.startsWith("sensor."));return G`

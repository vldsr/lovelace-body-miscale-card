...
@media (max-width: 400px) {
  ...
  .segment-label {
    ...
    `:K}renderState(e){var a,o,i,t,l;if(!this.config.show_states)return K;if(!this.hass||!(null===(a=this.config)||void 0===a?void 0:a.entity))return G`<div>${$l("state.default.unavailable")}</div>`;const n=null===(o=this.hass.states)||void 0===o?void 0:o[this.config.entity];if(!n)return G`<div>
        ...
        ${this.hass.localize("state.default.unavailable")}
      </div>`;const r="function"==typeof e.compute?e.compute:e=>e,s=(null==e?void 0:e.key)&&n,d=s&&void 0!==(null===(i=n.attributes)||void 0===i?void 0:i[e.key]),c=s&&void 0!==n[e.key];let _=d?r(n.attributes[e.key]):c?r(n[e.key]):this.hass.localize("state.default.unavailable");if("last_measurement_time"===e.key&&"string"==typeof _)try{const e=new Date(_.replace(" ","T")),a=ge(e,this.hass.locale);_=`${a} ${ye(e,this.hass.locale)}`}catch(e){}else"gender"==e.key?_=this.renderIcon({icon:"male"===_?"mdi:human-male":"mdi:human-female",key:""},"default",!0):"birthdate"==e.key&&(d||c)&&(_=function(e){const a=new Date,o=new Date(e);let i=a.getFullYear()-o.getFullYear();const t=a.getMonth()-o.getMonth(),l=a.getDate()-o.getDate();return(t<0||0===t&&l<0)&&i--,i}(_),e.unit=_>20&&_%10==1?" год":_>20&&(_%10==2||_%10==3||_%10==4)?" года":" лет");const b="number"==typeof _?ke(_,this.hass.locale):_,h=$l(`attributes_value.${_}`)||b,m=G`<div>
